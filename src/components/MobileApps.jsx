  ...
  const services = [
    {
      ...
      description:
        "Membangun aplikasi mobile profesional untuk menjangkau pengguna di platform Android dan iOS dengan lancar.",
      icon: Smartphone,
      gradient: "from-blue-700 to-blue-800",
      features: [
        "Pengembangan Native & Hybrid",
        "Desain UX modern dan intuitif",
    ...
    },
    {
      ...
      description:
        "Solusi mobile yang disesuaikan untuk mendukung operasional bisnis Anda — mulai dari otomatisasi workflow hingga sistem manajemen.",
      icon: Settings2,
    ...
    {
      title: "Prototipe & Desain UI/UX",
      description:
        "Kami membantu mewujudkan ide aplikasi Anda dengan desain antarmuka yang cantik dan ramah pengguna.",
      icon: Code2,
      gradient: "from-blue-700 to-blue-600",
      features: [
        "Desain interaktif menggunakan Figma",
        "Perencanaan alur pengguna yang efisien",
        "Pengujian pengalaman pengguna",
      ],
    },
    {
      title: "Publikasi & Pemeliharaan Aplikasi",
      description:
        "Mulai dari upload ke Play Store/App Store hingga pemeliharaan berkelanjutan — kami membantu mengelola aplikasi Anda secara lengkap.",
      icon: Rocket,
      gradient: "from-blue-600 to-blue-700",
      features: [
        "Dukungan pengiriman & revisi aplikasi",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 shadow-lg mb-8 group transition-colors">
            <span className="text-sm font-medium">Layanan Aplikasi Mobile</span>
          ...
          <p className="mt-6 text-xl text-slate-600 dark:text-slate-400 leading-relaxed">
            Kami menghadirkan aplikasi mobile berkualitas tinggi dengan desain elegan,
            performa cepat, dan pengalaman pengguna yang luar biasa.
          </p>
        </div>
          ...
          <div className="w-full max-w-2xl p-8 rounded-3xl bg-slate-900 dark:bg-slate-100 text-center relative overflow-hidden transition-colors">
            ...
            <div className="relative space-y-6">
              <h3 className="text-2xl font-bold text-white dark:text-slate-900">
                Butuh Aplikasi Mobile Kustom?
              </h3>
              <p className="text-slate-400 dark:text-slate-500">
                Diskusikan ide Anda dengan tim pengembang kami hari ini.
              </p>
